...
If you find a vulnerability, please report it using [GitHub's private vulnerability reporting](https://github.com/fastapi/full-stack-fastapi-template/security).
