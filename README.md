...
- `domain_staging`: (default: `"staging.localhost.tiangolo.com"`) The domain for the staging environment, you can set it later in .env.
- `domain_production`: (default: `"localhost.tiangolo.com"`) The domain for the production environment, you can set it later in .env.
