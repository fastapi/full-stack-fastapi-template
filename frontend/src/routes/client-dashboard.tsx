...
import { FiHome, FiDollarSign, FiTrendingUp, FiCreditCard, FiEye, FiHeart, FiCalendar, FiBarChart, FiPieChart, FiDownload, FiPlus, FiEdit3, FiTrash2, FiMapPin, FiUser, FiPhone, FiMail } from "react-icons/fi";
...
function ClientDashboard() {
  ...
  // Si Clerk está cargando, mostrar loading
  if (!isLoaded) {
    return (
        ...
        <div className="max-w-md w-full bg-white rounded-lg shadow-xl p-8">
          <div className="text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              />
              <h1 className="text-2xl font-bold text-gray-900">GENIUS INDUSTRIES</h1>
            </div>
            ...
            <p className="text-gray-600 mb-8">
              Necesitas iniciar sesión para acceder a tu dashboard personalizado
            </p>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <h3 className="text-sm font-semibold text-gray-900 mb-3">
                Con tu dashboard podrás:
              </h3>
              <ul className="text-sm text-gray-600 space-y-2">
                <li className="flex items-center gap-2">
                  <FiHome size={14} className="text-green-600" />
                  Gestionar tus propiedades
                </li>
                <li className="flex items-center gap-2">
                  <FiCreditCard size={14} className="text-blue-600" />
                ...
                <li className="flex items-center gap-2">
                  <FiBarChart size={14} className="text-yellow-600" />
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between py-3 border-b border-gray-200">
                  ...
                  <span className="text-green-600 font-semibold">+{formatCurrency(3200000, "COP")}</span>
                </div>
                ...
                <div className="flex items-center justify-between py-3 border-b border-gray-200">
                  ...
                  <span className="text-blue-600 font-semibold">+{formatCurrency(708333, "COP")}</span>
                </div>
                ...
                <div className="flex items-center justify-between py-3">
                  ...
                  <span className="text-red-600 font-semibold">-{formatCurrency(2850000, "COP")}</span>
                </div>
              </div>
            </div>
          </div>
