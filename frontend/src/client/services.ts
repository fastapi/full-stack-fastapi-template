...
export type TDataReadStores = {
  ...
  export type TDataUpdateStoreInventory = {
	id: number;
	requestBody: StoreInventoryUpdate;
  };
...
export class StoresService {
   ...
   * @throws ApiError
   */
  public static readStoreInventory(
    data: TDataReadStore
  ): CancelablePromise<{
    data: ItemPublic[]}> {
    const { id } = data;
    return __request(OpenAPI, {
      method: "GET",
      url: "/api/v1/stores/{id}/inventory",
      path: {
        id,
      },
      errors: {
   ...
   * @throws ApiError
   */
    public static updateStoreInventory(
      data: TDataUpdateStoreInventory
    ): CancelablePromise<StoreInventoryUpdate> {
      const { id, requestBody } = data;
      return __request(OpenAPI, {
        method: "POST",
        url: "/api/v1/stores/{id}/add",
        path: {
          id,
        },
        body: requestBody,
