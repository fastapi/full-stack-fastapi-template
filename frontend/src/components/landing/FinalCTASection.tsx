    ...
    <section className="relative py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="font-body text-lg text-slate-300 mb-8 max-w-2xl mx-auto">
          Join brands already tracking their AI search presence. Start your free
          28-day trial — no credit card required.
        </p>
        ...
        <p className="mt-6 text-sm text-slate-400">
          ✓ No credit card required &nbsp; ✓ 28-day free trial &nbsp; ✓ Cancel
          anytime
        </p>
      </div>
    </section>
