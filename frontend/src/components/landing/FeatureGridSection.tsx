...
const features = [
  {
    ...
    description:
      "Monitor how your brand appears in AI search results across all major platforms",
    color: "blue",
  },
  {
    icon: Target,
    ...
    description:
      "Compare your visibility against competitors and spot displacement early",
    color: "indigo",
  },
  {
    icon: TrendingUp,
    ...
    description:
      "Track category shifts, visibility volatility, and emerging market patterns",
    color: "sky",
  },
  {
    icon: UserStar,
    ...
    description:
      "Early sentiment signals before your visibility drops or competitors gain ground",
    color: "rose",
  },
  {
    icon: BarChart3,
    ...
    description:
      "Drill down into specific market segments for targeted analysis",
    color: "violet",
  },
  {
    icon: Users,
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="font-body text-base text-slate-600 mt-4 max-w-2xl mx-auto">
            Comprehensive tools to track, analyze, and optimize your brand's
