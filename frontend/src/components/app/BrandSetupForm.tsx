/**
 * BrandSetupForm Component
 *
 * Simplified form for creating a new brand with monitoring settings.
 * Features:
 * - Single form view (no tabs)
 * - Brand name and optional description at the top
 * - Up to 3 segments with prompts
 * - Save & Submit button to create the brand
 */
...
export function BrandSetupForm({
  ...
  const handleGetSuggestion = (segmentId: string) => {
    ...
    console.log("[BrandSetupForm] Get suggestion for segment:", segmentId)
  }
  ...
  return (
    <Card className="mt-6">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
        <CardTitle className="text-xl font-bold">New Brand Setup</CardTitle>
...
export type { BrandFormData, Segment }
